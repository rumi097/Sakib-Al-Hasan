    ...
    <div className="overflow-hidden">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 space-y-16">
          ...
          {previews?.showcaseAchievements?.enabled && previews.showcaseAchievements.selectedAchievements?.length > 0 && (
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <motion.h2 
                ...
                transition={{ duration: 0.5 }}
              >
                {previews.showcaseAchievements.title}
              </motion.h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                {previews.showcaseAchievements.selectedAchievements.map((achievement, index) => {
                  const categoryColors: { [key: string]: { bg: string; badge: string; border: string; shadow: string } } = {
                    academic: {
                      bg: 'from-blue-50/80 via-white to-indigo-50/30',
                      badge: 'from-blue-50 to-indigo-50 border-blue-100 text-blue-700',
                      border: 'border-blue-100/60',
                      shadow: 'rgba(59, 130, 246, 0.15)'
                    },
                    research: {
                      bg: 'from-purple-50/80 via-white to-pink-50/30',
                      badge: 'from-purple-50 to-pink-50 border-purple-100 text-purple-700',
                      border: 'border-purple-100/60',
                      shadow: 'rgba(147, 51, 234, 0.15)'
                    },
                    professional: {
                      bg: 'from-emerald-50/80 via-white to-teal-50/30',
                      badge: 'from-emerald-50 to-teal-50 border-emerald-100 text-emerald-700',
                      border: 'border-emerald-100/60',
                      shadow: 'rgba(16, 185, 129, 0.15)'
                    },
                    competition: {
                      bg: 'from-orange-50/80 via-white to-amber-50/30',
                      badge: 'from-orange-50 to-amber-50 border-orange-100 text-orange-700',
                      border: 'border-orange-100/60',
                      shadow: 'rgba(249, 115, 22, 0.15)'
                    },
                    award: {
                      bg: 'from-yellow-50/80 via-white to-amber-50/30',
                      badge: 'from-yellow-50 to-amber-50 border-yellow-100 text-yellow-700',
                      border: 'border-yellow-100/60',
                      shadow: 'rgba(234, 179, 8, 0.15)'
                    },
                    certification: {
                      bg: 'from-cyan-50/80 via-white to-blue-50/30',
                      badge: 'from-cyan-50 to-blue-50 border-cyan-100 text-cyan-700',
                      border: 'border-cyan-100/60',
                      shadow: 'rgba(6, 182, 212, 0.15)'
                    },
                    other: {
                      bg: 'from-gray-50/80 via-white to-slate-50/30',
                      badge: 'from-gray-50 to-slate-50 border-gray-100 text-gray-700',
                  ...
                  return (
                    <motion.div
                      key={achievement._id}
                      className={`relative group overflow-hidden rounded-2xl shadow-md hover:shadow-xl bg-linear-to-br ${colors.bg} border ${colors.border} backdrop-blur-xl p-5`}
                      initial={{ opacity: 0, scale: 0.9 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.4, delay: index * 0.1 }}
                      whileHover={{ y: -8, scale: 1.02, boxShadow: `0 20px 40px -12px ${colors.shadow}` }}
                    >
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <span className={`text-xs font-bold px-2.5 py-1 rounded-full bg-linear-to-r ${colors.badge} border`}>
                      ...
                      <h4 className="text-sm font-bold text-gray-900 mb-2 line-clamp-2">{achievement.title}</h4>
                      
                      {achievement.organization && (
                        <p className="text-xs text-gray-600 mb-2">{achievement.organization}</p>
                      )}
                      ...
                      <p className="text-xs text-gray-700 line-clamp-3 leading-relaxed">{achievement.description}</p>
                    </motion.div>
                  );
                })}
              </div>
